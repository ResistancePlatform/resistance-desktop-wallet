      ...
      .then(result => {
        ...
        if (Array.isArray(PublicAddressesUnspendResult)) {
          ...
          for (let index = 0; index < PublicAddressesUnspendResult.length; index += 1) {
            if((PublicAddressesUnspendResult[index].hasOwnProperty('spendable') && PublicAddressesUnspendResult[index].spendable)){
              publicAddressResultSet.add(PublicAddressesUnspendResult[index].address)
            } else {
              var addressToRemove = PublicAddressesUnspendResult[index].address
