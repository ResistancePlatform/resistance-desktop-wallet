...
export const SendCashActions = {
	...
	TEST_START_OPERATION: `${sendCashActionTypePrefix}: TEST_START_OPERATION`,
	TEST_STOP_OPERATION: `${sendCashActionTypePrefix}: TEST_STOP_OPERATION`,
	...
	testStartOperation: () => ({ type: SendCashActions.TEST_START_OPERATION }),
	testStopOperation: () => ({ type: SendCashActions.TEST_STOP_OPERATION }),
...
export const SendCashReducer = (
	...
	switch (action.type) {
		...
		case SendCashActions.TEST_START_OPERATION:
		...
		case SendCashActions.TEST_STOP_OPERATION:
			return { ...state, currentOperation: null }
